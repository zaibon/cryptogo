...
//adapted from https://github.com/astaxie/beego/blob/master/template.go
...
func init() {
	...
	beegoTplFuncMap["timestampformat"] = TimeStampFormat
	...
	beegoTplFuncMap["urlencode"] = UrlEncode
	beegoTplFuncMap["underscorespace"] = UnderscoreSpace
